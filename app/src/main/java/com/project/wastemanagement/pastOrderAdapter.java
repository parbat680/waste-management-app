...
public class pastOrderAdapter extends ArrayAdapter<buyerorders> {


    ArrayList<buyerorders> details;
    Context context;

    public pastOrderAdapter(@NonNull Context context, ArrayList<buyerorders> details) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView= LayoutInflater.from(context).inflate(R.layout.buyer_order_done_list,parent,false);
